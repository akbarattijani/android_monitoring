...
public class RegisterStep3 extends AppCompatActivity implements View.OnClickListener, TransportListener {
    ...
    public void onClick(View v) {
        if (v == rlNext) {
            ProgressDialog dialog = new ProgressDialog(RegisterStep3.this);
            dialog.show();
                ...
                public void run() {
                    try {
                        ...
                        new Transporter()
                                ...
                                .context(RegisterStep3.this)
                                .listener(RegisterStep3.this)
    ...
    public void onTransportDone(Object code, Object message, Object body, int id, Object... packet) {
        try {
            ...
            if (id == RC_SEND_SIGNATURE) {
                ...
                if (Integer.parseInt(json.get("code").toString()) == 200) {
                    Intent intent = new Intent(this, RegisterStep4.class);
