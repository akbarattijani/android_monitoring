...
public class RegisterStep8 extends AppCompatActivity implements View.OnClickListener, TransportListener {
    ...
    public void onClick(View v) {
        if (v == rlNext) {
            ProgressDialog dialog = new ProgressDialog(RegisterStep8.this);
            dialog.show();
                ...
                public void run() {
                    try {
                        ...
                        new Transporter()
                                ...
                                .context(RegisterStep8.this)
                                .listener(RegisterStep8.this)
    ...
    public void onTransportDone(Object code, Object message, Object body, int id, Object... packet) {
        try {
            ...
            if (id == RC_SEND_SIGNATURE) {
                ...
                if (Integer.parseInt(json.get("code").toString()) == 200) {
                    Intent intent = new Intent(this, RegisterStep9.class);
