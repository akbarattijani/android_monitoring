...
import ip.signature.com.signatureapps.activity.MenuActivity;

public class RegisterStepFinal extends AppCompatActivity implements View.OnClickListener, TransportListener {
    ...
    public void onClick(View v) {
        if (v == rlNext) {
            ProgressDialog dialog = new ProgressDialog(RegisterStepFinal.this);
            dialog.show();
                ...
                public void run() {
                    try {
                        ...
                        new Transporter()
                                ...
                                .context(RegisterStepFinal.this)
                                .listener(RegisterStepFinal.this)
