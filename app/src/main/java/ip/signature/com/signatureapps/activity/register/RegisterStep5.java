...
public class RegisterStep5 extends AppCompatActivity implements View.OnClickListener, TransportListener {
    ...
    public void onClick(View v) {
        if (v == rlNext) {
            ProgressDialog dialog = new ProgressDialog(RegisterStep5.this);
            dialog.show();
                ...
                public void run() {
                    try {
                        ...
                        new Transporter()
                                ...
                                .context(RegisterStep5.this)
                                .listener(RegisterStep5.this)
    ...
    public void onTransportDone(Object code, Object message, Object body, int id, Object... packet) {
        try {
            ...
            if (id == RC_SEND_SIGNATURE) {
                ...
                if (Integer.parseInt(json.get("code").toString()) == 200) {
                    Intent intent = new Intent(this, RegisterStep6.class);
