...
public class BreakOutActivity extends AppCompatActivity implements View.OnClickListener, TransportListener, AlertDialogListener.OneButton {
    ...
    public void onClick(View v) {
        if (v == back || v == btnBatal) {
            ...
            try {
                ...
                params.put("break_start_date", new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(timestamp));
                ...
                new Transporter()
                        ...
                        .route("/api/v1/attendance/breakOut")
    ...
    public void onTransportDone(Object code, Object message, Object body, int id, Object... packet) {
        try {
            ...
            if (Integer.parseInt(json.get("code").toString()) == 200) {
                ...
                if (res.equals("true")) {
                    Toast.makeText(this, "Berhasil absen istirahat", Toast.LENGTH_SHORT).show();
                    onBackPressed();
                } else {
