...
public class RegisterStep2 extends AppCompatActivity implements View.OnClickListener, TransportListener {
    ...
    public void onClick(View v) {
        if (v == rlNext) {
            ProgressDialog dialog = new ProgressDialog(RegisterStep2.this);
            dialog.show();
                ...
                public void run() {
                    try {
                        ...
                        new Transporter()
                                ...
                                .context(RegisterStep2.this)
                                .listener(RegisterStep2.this)
