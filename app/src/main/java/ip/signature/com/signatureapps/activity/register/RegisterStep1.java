...
public class RegisterStep1 extends AppCompatActivity implements View.OnClickListener, TransportListener {
    ...
    public void onClick(View v) {
        if (v == rlNext) {
            ProgressDialog dialog = new ProgressDialog(RegisterStep1.this);
            dialog.show();
                ...
                public void run() {
                    try {
                        ...
                        new Transporter()
                                ...
                                .context(RegisterStep1.this)
                                .listener(RegisterStep1.this)
